	...
	<main id="js-page-content" role="main" class="page-content">
		...
		<div id=back>
			...
			<div id="page-content">
				...
				<div class="panel">
					...
					<form action="dgNoticeBoardInsert">
						<button  class="btn btn-primary" style="margin-left: 1.5%; margin-top: 1%">Write</button>
					</form>
					</div>
					<div class="panel-body">
						<table id="demo-dt-basic"
							...
							<tbody>
								<c:forEach var="dgNoticeBoardList"
									items="${ dgNoticeBoardList }">
									<!--                            온클릭 작성하고 자바스크립트 함수 추가! -->
									<tr
										onclick="dgNoticeBoardDetail(${dgNoticeBoardList.dg_board_num})">
						...
						<div class="nano-content">
							...
							<ul class="nav nav-tabs nav-justified">
								<li class="active"><a href="#demo-asd-tab-1"
									data-toggle="tab"> <i
										class="demo-pli-speech-bubble-7 icon-lg"></i>
								</a></li>
								<li><a href="#demo-asd-tab-2" data-toggle="tab"> <i
										class="demo-pli-information icon-lg icon-fw"></i> Report
								</a></li>
								<li><a href="#demo-asd-tab-3" data-toggle="tab"> <i
										class="demo-pli-wrench icon-lg icon-fw"></i> Settings
								</a></li>
							</ul>
							<!--================================-->
							<!--End nav tabs-->
										...
										<a href="#" class="list-group-item">
											<div class="media-left pos-rel">
												<img class="img-circle img-xs"
													src="/resource/img/profile-photos/2.png"
											...
											<div class="media-left pos-rel">
												<img class="img-circle img-xs"
													src="img/profile-photos/7.png" alt="Profile Picture">
											</div>
											<div class="media-body">
											...
											<div class="media-left pos-rel">
												<img class="img-circle img-xs"
													src="/resource/img/profile-photos/1.png"
													alt="Profile Picture"> <i
											...
											<div class="media-left pos-rel">
												<img class="img-circle img-xs"
													src="/resource/img/profile-photos/4.png"
													alt="Profile Picture">
											</div>
											<div class="media-body">
												<p class="mar-no text-main">Donald Brown</p>
												<small class="text-muteds">Lorem ipsum dolor sit
													amet.</small>
											</div>
										</a> <a href="#" class="list-group-item">
											<div class="media-left pos-rel">
											...
											<div class="media-left pos-rel">
												<img class="img-circle img-xs"
													src="/resource/img/profile-photos/9.png"
													alt="Profile Picture"> <i
								...
								<div class="tab-pane fade" id="demo-asd-tab-2">
									...
									<div class="pad-all">
										<p class="pad-ver text-main text-sm text-uppercase text-bold">Billing
											&amp; reports</p>
										<p>
											Get <strong class="text-main">$5.00</strong> off your next
											bill by making sure your full payment reaches us before
											August 5, 2018.
										</p>
									</div>
									...
									<div class="pad-all">
										<span
											class="pad-ver text-main text-sm text-uppercase text-bold">Amount
											Due On</span>
									...
									<div class="text-center">
										...
										Questions?
										<p class="text-lg text-semibold text-main">(415) 234-53454
										</p>
		...
		<footer id="footer">
			...
			<div class="show-fixed pad-rgt pull-right">
				You have <a href="#" class="text-main"><span
					class="badge badge-danger">3</span> pending action.</a>
			</div>
		...
		<!--DataTables [ OPTIONAL ]-->
		<script
			src="/resource/plugins/datatables/media/js/jquery.dataTables.js"></script>
		<script
			src="/resource/plugins/datatables/media/js/dataTables.bootstrap.js"></script>
		<script
			src="/resource/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
...
function dgNoticeBoardDetail(dg_board_num){
    location.href='/dgNoticeBoardDetail?dg_board_num='+dg_board_num;
