            ...
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand">
                        <img src="/resource/img/logo.png" alt="Nifty Logo" class="brand-icon">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="row img-gallery">
                                            <div class="col-xs-4">
                                                <img class="img-responsive" src="/resource/img/thumbs/img-1.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="img-responsive" src="/resource/img/thumbs/img-3.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="img-responsive" src="/resource/img/thumbs/img-2.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="img-responsive" src="/resource/img/thumbs/img-4.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="img-responsive" src="/resource/img/thumbs/img-6.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="img-responsive" src="/resource/img/thumbs/img-5.jpg" alt="thumbs">
                                            </div>
                                        </div>
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="/resource/img/profile-photos/9.png">
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="/resource/img/profile-photos/3.png">
                                                    </div>
                                                    <div class="media-body">
